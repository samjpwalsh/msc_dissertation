...
if __name__ == "__main__":
    ...
    for i in range(EVALUATION_PIPELINE_RUNS):
        ...
        if i == 0:
            video_folder = './test_data/key_corridor/videos'
        else:
            video_folder = None
    ...
    with open(rf'./test_data/key_corridor/data/rnd_rewards_{dt.date.today()}.pkl', 'wb+') as f:
        pickle.dump(rewards, f)

    with open(rf'./test_data/key_corridor/data/rnd_ftvs_{dt.date.today()}.pkl', 'wb+') as f:
        pickle.dump(ftvs, f)
