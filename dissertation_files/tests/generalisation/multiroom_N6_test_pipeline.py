...
if __name__ == "__main__":
    ...
    eval_env = gym.make("MiniGrid-MultiRoom-N6-v0", render_mode='rgb_array')
    ...
    #
    #     if i == 0:
    #         video_folder = '../test_data/generalisation_multiroom_N6/videos'
    #     else:
    #         video_folder = None
    #
    ...
    #         'C:/Users/samjp/anaconda3/envs/msc-dissertation/msc_dissertation/dissertation_files/tests/test_data/checkpoints/multiroom_N4',
    #         restore_rnd_networks=False
    #     )
    #
    #     for layer in agent.actor.layers[0:2]:
    ...
    #         ftvs[key] = np.mean(ftvs[key])
    #
    # with open(rf'../test_data/generalisation_multiroom_N6/data/rnd_rewards_{dt.date.today()}.pkl', 'wb+') as f:
    #     pickle.dump(rewards, f)
    #
    # with open(rf'../test_data/generalisation_multiroom_N6/data/rnd_ftvs_{dt.date.today()}.pkl', 'wb+') as f:
    #     pickle.dump(ftvs, f)
    ...
    for i in range(EVALUATION_PIPELINE_RUNS):
        print(f"RND (no pretraining) Agent Run {i+1}")

        if i == 0:
            video_folder = '../test_data/generalisation_multiroom_N6_no_pretrain/videos'
        else:
            video_folder = None
    ...
    with open(rf'../test_data/generalisation_multiroom_N6_no_pretrain/data/rnd_no_pretrain_rewards_{dt.date.today()}.pkl', 'wb+') as f:
        pickle.dump(rewards, f)

    with open(rf'../test_data/generalisation_multiroom_N6_no_pretrain/data/rnd_no_pretrain_ftvs_{dt.date.today()}.pkl', 'wb+') as f:
        pickle.dump(ftvs, f)
