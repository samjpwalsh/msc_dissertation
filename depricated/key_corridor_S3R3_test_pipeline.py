...
if __name__ == "__main__":
    ...
    eval_env = gym.make("MiniGrid-KeyCorridorS3R3", render_mode='rgb_array')
    ...
    #
    #     if i == 0:
    #         video_folder = '../test_data/sparse_key_corridor_S3R3/videos'
    #     else:
    #         video_folder = None
    #
    #     agent = RandomAgent(
    ...
    #         ftvs[key] = np.mean(ftvs[key])
    #
    # with open(rf'../test_data/sparse_key_corridor_S3R3/data/random_rewards_{dt.date.today()}.pkl', 'wb+') as f:
    #     pickle.dump(rewards, f)
    #
    # with open(rf'../test_data/sparse_key_corridor_S3R3/data/random_ftvs_{dt.date.today()}.pkl', 'wb+') as f:
    #     pickle.dump(ftvs, f)
    ...
    #         ftvs[key] = np.mean(ftvs[key])
    #
    # with open(rf'../test_data/sparse_key_corridor_S3R3/data/dqn_rewards_{dt.date.today()}.pkl', 'wb+') as f:
    #     pickle.dump(rewards, f)
    #
    # with open(rf'../test_data/sparse_key_corridor_S3R3/data/dqn_ftvs_{dt.date.today()}.pkl', 'wb+') as f:
    #     pickle.dump(ftvs, f)
    ...
    #         ftvs[key] = np.mean(ftvs[key])
    #
    # with open(rf'../test_data/sparse_key_corridor_S3R3/data/rnd_rewards_{dt.date.today()}.pkl', 'wb+') as f:
    #     pickle.dump(rewards, f)
    #
    # with open(rf'../test_data/sparse_key_corridor_S3R3/data/rnd_ftvs_{dt.date.today()}.pkl', 'wb+') as f:
    #     pickle.dump(ftvs, f)
